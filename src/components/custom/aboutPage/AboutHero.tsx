        ...
        <WidthCard>
            <div className='grid grid-cols-1  md:grid-cols-3'>
                ...
                <div className='col-span-2 mt-16'>
                    ...
                    <div className='flex items-center justify-between gap-2 md:gap-6 flex-col w-full md:flex-row'>
                        <div className='flex flex-col gap-4 my-1 md:my-4 bg-white flex-1 rounded-xl items-center py-6 w-full'>
