    ...
    return (
        <div className='w-full h-full border border-primary rounded-xl col-span-1 row-span-4'>
            ...
            {!cartItem ? (
                ...
                <div className='flex items-center justify-center   mx-3 rounded-md border-dark border py-1'>
                    <p className='mr-1'>Qty.</p>
                    <div className='flex items-center border border-primary rounded-md py-1 px-2 hover:bg-red-500 cursor-pointer  hover:text-white' onClick={() => updateQuantity(-1)}>
                        <button

                            className='px-1 text-lg font-bold  cursor-pointer'
                        >
                            −
                        </button>
                    </div>
                    <span className='px-2'>{cartItem.quantity}</span>
                    <div className='flex items-center border border-primary rounded-md py-1 px-2 hover:bg-green-500 cursor-pointer  hover:text-white' onClick={() => updateQuantity(1)}>
                        <button
